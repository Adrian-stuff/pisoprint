!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = t(require("jszip")))
    : "function" == typeof define && define.amd
    ? define(["jszip"], t)
    : "object" == typeof exports
    ? (exports.docx = t(require("jszip")))
    : (e.docx = t(e.JSZip));
})(globalThis, (e) =>
  (() => {
    "use strict";
    var t = {
        ...
        522: (e, t, r) => {
          ...
          class o {
            constructor(e, t) {
              (this._zip = e),
                (this.options = t),
                (this.xmlParser = new s.XmlParser());
            }
            get(e) {
            ...
            loadRelationships(e = null) {
              ...
              return this.load(t).then((e) =>
                e
                  ? (0, l.parseRelationships)(
                      this.parseXmlDocument(e).firstElementChild,
                      this.xmlParser
                    )
                  : null
              );
        ...
        530: (e, t, r) => {
          ...
          t.Part = class {
            ...
            load() {
              return Promise.all([
                this._package.loadRelationships(this.path).then((e) => {
                  this.rels = e;
                }),
            ...
            save() {
              this._package.update(
                this.path,
                (0, a.serializeXmlString)(this._xmlDocument)
              );
            }
            parseXml(e) {}
          };
        ...
        461: (e, t) => {
          var r;
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseRelationships = t.RelationshipTypes = void 0),
            ((r =
              t.RelationshipTypes ||
              (t.RelationshipTypes = {})).OfficeDocument =
        ...
        168: (e, t, r) => {
          ...
          t.DocumentParser = class {
            constructor(e) {
              this.options = Object.assign({ ignoreWidth: !1, debug: !1 }, e);
            }
            parseNotes(e, t, r) {
              var a = [];
              for (let s of l.default.elements(e, t)) {
                const e = new r();
                (e.id = l.default.attr(s, "id")),
                  (e.noteType = l.default.attr(s, "type")),
                  (e.children = this.parseBodyElements(s)),
                  a.push(e);
              }
              return a;
            }
            ...
            parseBodyElements(e) {
              ...
              return (
                m.foreach(e, (e) => {
                  switch (e.localName) {
                    case "p":
                      t.push(this.parseParagraph(e));
                      break;
                    case "tbl":
                      t.push(this.parseTable(e));
                      break;
                    case "sdt":
                      this.parseSdt(e).forEach((e) => t.push(e));
                  }
                }),
                t
              );
                  ...
                  switch (e.localName) {
                    ...
                    case "pPr":
                      t.styles.push({
                        ...
                        (t.paragraphProps = (0, s.parseParagraphProperties)(
                          e,
                          l.default
                        ));
                      break;
                    ...
                    default:
                      this.options.debug &&
                        console.warn(
                          `DOCX: Unknown style element: ${e.localName}`
                        );
                  }
                }),
                t
            ...
            parseNumberingFile(e) {
              ...
              return (
                m.foreach(e, (e) => {
                  switch (e.localName) {
                    case "abstractNum":
                      this.parseAbstractNumbering(e, a).forEach((e) =>
                        t.push(e)
                      );
                      break;
                    case "numPicBullet":
            ...
            parseAbstractNumbering(e, t) {
              ...
              return (
                m.foreach(e, (e) => {
                  "lvl" === e.localName &&
                    r.push(this.parseNumberingLevel(a, e, t));
                }),
                r
              );
            }
            ...
            parseSdt(e) {
              const t = l.default.element(e, "sdtContent");
              return t ? this.parseBodyElements(t) : [];
            }
            parseParagraph(e) {
              ...
              return (
                m.foreach(e, (e) => {
                  switch (e.localName) {
                    case "r":
                      t.children.push(this.parseRun(e, t));
                      break;
                    case "hyperlink":
                      t.children.push(this.parseHyperlink(e, t));
                      break;
                    case "bookmarkStart":
                      t.children.push((0, i.parseBookmarkStart)(e, l.default));
                      break;
                    case "bookmarkEnd":
                      t.children.push((0, i.parseBookmarkEnd)(e, l.default));
                      break;
                    case "oMath":
                    case "oMathPara":
                      t.children.push(this.parseMathElement(e));
                      break;
                    case "pPr":
                      this.parseParagraphProperties(e, t);
                  }
                }),
                t
              );
            ...
            parseFrame(e, t) {
              "drop" == l.default.attr(e, "dropCap") &&
                (t.cssStyle.float = "left");
            }
            parseHyperlink(e, t) {
              var r = { type: a.DomType.Hyperlink, parent: t, children: [] },
            ...
            parseRun(e, t) {
              var r = { type: a.DomType.Run, parent: t, children: [] };
              return (
                m.foreach(e, (e) => {
                  switch ((e = this.checkAlternateContent(e)).localName) {
                    ...
                    case "fldChar":
                      ...
                      break;
                    case "noBreakHyphen":
                      r.children.push({ type: a.DomType.NoBreakHyphen });
                      break;
                    case "br":
                      r.children.push({
                    ...
                    case "sym":
                      ...
                      break;
                    case "tab":
                      r.children.push({ type: a.DomType.Tab });
                      break;
            ...
            parseMathElement(e) {
              const t = `${e.localName}Pr`,
                r = { type: d[e.localName], children: [] };
              for (const a of l.default.elements(e))
                d[a.localName]
                  ? r.children.push(this.parseMathElement(a))
                  : "r" == a.localName
                  ? r.children.push(this.parseRun(a))
                  : a.localName == t && (r.props = this.parseMathProperies(a));
              return r;
            }
            ...
            checkAlternateContent(e) {
              ...
              return null === (t = l.default.element(e, "Fallback")) ||
                void 0 === t
                ? void 0
                : t.firstElementChild;
            }
            parseDrawing(e) {
              for (var t of l.default.elements(e))
                switch (t.localName) {
                  case "inline":
                  case "anchor":
            ...
            parseDrawingWrapper(e) {
              var t,
                r = { type: a.DomType.Drawing, children: [], cssStyle: {} },
                s = "anchor" == e.localName;
              let n = null,
                o = l.default.boolAttr(e, "simplePos"),
                i = { relative: "page", align: "left", offset: "0" },
                u = { relative: "page", align: "top", offset: "0" };
              for (var p of l.default.elements(e))
                switch (p.localName) {
                  case "simplePos":
                    o &&
                      ((i.offset = l.default.lengthAttr(
                        p,
                        "x",
                        c.LengthUsage.Emu
                      )),
                      (u.offset = l.default.lengthAttr(
                        p,
                        "y",
                        c.LengthUsage.Emu
                      )));
                    break;
                  case "extent":
                    (r.cssStyle.width = l.default.lengthAttr(
                      p,
                      "cx",
                      c.LengthUsage.Emu
                    )),
                      (r.cssStyle.height = l.default.lengthAttr(
                        p,
                        "cy",
                        c.LengthUsage.Emu
                      ));
                  ...
                  case "positionV":
                    if (!o) {
                      ...
                      (e.relative =
                        null !== (t = l.default.attr(p, "relativeFrom")) &&
                        void 0 !== t
                          ? t
                          : e.relative),
                        d && (e.align = d.textContent),
                        h && (e.offset = m.sizeValue(h, c.LengthUsage.Emu));
                    }
                    break;
              ...
              return (
                "wrapTopAndBottom" == n
                  ? ((r.cssStyle.display = "block"),
                    i.align &&
                      ((r.cssStyle["text-align"] = i.align),
                      (r.cssStyle.width = "100%")))
                  : "wrapNone" == n
                  ? ((r.cssStyle.display = "block"),
                    (r.cssStyle.position = "relative"),
                    (r.cssStyle.width = "0px"),
                    (r.cssStyle.height = "0px"),
                    i.offset && (r.cssStyle.left = i.offset),
                    u.offset && (r.cssStyle.top = u.offset))
                  : !s ||
                    ("left" != i.align && "right" != i.align) ||
                    (r.cssStyle.float = i.align),
                r
              );
            }
            parseGraphic(e) {
              var t = l.default.element(e, "graphicData");
              for (let e of l.default.elements(t))
                if ("pic" === e.localName) return this.parsePicture(e);
              return null;
            }
            parsePicture(e) {
              var t = { type: a.DomType.Image, src: "", cssStyle: {} },
              ...
              for (var i of ((t.cssStyle.position = "relative"),
              l.default.elements(o)))
                switch (i.localName) {
                  case "ext":
                    (t.cssStyle.width = l.default.lengthAttr(
                      i,
                      "cx",
                      c.LengthUsage.Emu
                    )),
                      (t.cssStyle.height = l.default.lengthAttr(
                        i,
                        "cy",
                        c.LengthUsage.Emu
                      ));
                    break;
                  case "off":
                    (t.cssStyle.left = l.default.lengthAttr(
                      i,
                      "x",
                      c.LengthUsage.Emu
                    )),
                      (t.cssStyle.top = l.default.lengthAttr(
                        i,
                        "y",
                        c.LengthUsage.Emu
                      ));
            ...
            parseTableColumns(e) {
              ...
              return (
                m.foreach(e, (e) => {
                  "gridCol" === e.localName &&
                    t.push({ width: l.default.lengthAttr(e, "w") });
                }),
                t
              );
            }
            ...
            parseTablePosition(e, t) {
              ...
              (t.cssStyle.float = "left"),
                (t.cssStyle["margin-bottom"] = f.addSize(
                  t.cssStyle["margin-bottom"],
                  a
                )),
                (t.cssStyle["margin-left"] = f.addSize(
                  t.cssStyle["margin-left"],
                  n
                )),
                (t.cssStyle["margin-right"] = f.addSize(
                  t.cssStyle["margin-right"],
                  s
                )),
                (t.cssStyle["margin-top"] = f.addSize(
                  t.cssStyle["margin-top"],
                  r
                ));
            }
            parseTableRow(e) {
            ...
            parseTableCellProperties(e, t) {
              t.cssStyle = this.parseDefaultProperties(e, {}, null, (e) => {
                ...
                switch (e.localName) {
                  ...
                  case "vMerge":
                    t.verticalMerge =
                      null !== (r = l.default.attr(e, "val")) && void 0 !== r
                        ? r
                        : "continue";
                    break;
                  case "cnfStyle":
                  ...
                  if (!(null == s ? void 0 : s(n)))
                    switch (n.localName) {
                      ...
                      case "color":
                        ...
                        break;
                      case "sz":
                        r["font-size"] = r["min-height"] = l.default.lengthAttr(
                          n,
                          "val",
                        ...
                        break;
                      case "shd":
                        r["background-color"] = m.colorAttr(
                          n,
                          "fill",
                          null,
                          t.autos.shd
                      ...
                      case "vertAlign":
                        break;
                      case "position":
                        r.verticalAlign = l.default.lengthAttr(
                          n,
                          "val",
                          c.LengthUsage.FontSize
                        );
                      ...
                      case "trHeight":
                        ...
                        break;
                      case "strike":
                        r["text-decoration"] = l.default.boolAttr(n, "val", !0)
                          ? "line-through"
                          : "none";
                        break;
                      case "b":
                        r["font-weight"] = l.default.boolAttr(n, "val", !0)
                          ? "bold"
                          : "normal";
                        break;
                      case "i":
                        r["font-style"] = l.default.boolAttr(n, "val", !0)
                          ? "italic"
                          : "normal";
                        break;
                      case "caps":
                        r["text-transform"] = l.default.boolAttr(n, "val", !0)
                          ? "uppercase"
                          : "none";
                        break;
                      case "smallCaps":
                      ...
                      case "tblBorders":
                        ...
                        break;
                      case "tblCellSpacing":
                        (r["border-spacing"] = f.valueOfMargin(n)),
                      ...
                      default:
                        this.options.debug &&
                          console.warn(
                            `DOCX: Unknown document element: ${e.localName}.${n.localName}`
                          );
                    }
                }),
                r
            ...
            parseFont(e, t) {
              var r = [
                l.default.attr(e, "ascii"),
                f.themeValue(e, "asciiTheme"),
              ]
                .filter((e) => e)
                .join(", ");
            ...
            parseIndentation(e, t) {
              ...
              r && (t["text-indent"] = r),
                a && (t["text-indent"] = `-${a}`),
                (s || n) && (t["margin-left"] = s || n),
                (o || i) && (t["margin-right"] = o || i);
            }
            parseSpacing(e, t) {
            ...
            parseTrHeight(e, t) {
              l.default.attr(e, "hRule"),
                (t.height = l.default.lengthAttr(e, "val"));
            }
          ...
          class f {
            ...
            static valueOfBorder(e) {
              ...
              return `${l.default.lengthAttr(
                e,
                "sz",
                c.LengthUsage.Border
              )} solid ${"auto" == r ? t.autos.borderColor : r}`;
            }
            ...
            static classNameOftblLook(e) {
              ...
              let r = "";
              return (
                (l.default.boolAttr(e, "firstRow") || 32 & t) &&
                  (r += " first-row"),
                (l.default.boolAttr(e, "lastRow") || 64 & t) &&
                  (r += " last-row"),
                (l.default.boolAttr(e, "firstColumn") || 128 & t) &&
                  (r += " first-col"),
                (l.default.boolAttr(e, "lastColumn") || 256 & t) &&
                  (r += " last-col"),
                (l.default.boolAttr(e, "noHBand") || 512 & t) &&
                  (r += " no-hband"),
                (l.default.boolAttr(e, "noVBand") || 1024 & t) &&
                  (r += " no-vband"),
                r.trim()
              );
            }
        ...
        614: (e, t) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseCoreProps = void 0),
            (t.parseCoreProps = function (e, t) {
              const r = {};
        ...
        821: (e, t) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseCustomProps = void 0),
            (t.parseCustomProps = function (e, t) {
        ...
        665: (e, t, r) => {
          ...
          class n extends a.Part {
            parseXml(e) {
              this.props = (0, s.parseExtendedProps)(
                e,
                this._package.xmlParser
              );
            }
          }
        ...
        668: (e, t) => {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseExtendedProps = void 0),
            (t.parseExtendedProps = function (e, t) {
              const a = {};
              for (let s of t.elements(e))
                switch (s.localName) {
                  case "Template":
        ...
        172: (e, t, r) => {
          ...
          (t.parseBookmarkStart = function (e, t) {
            ...
            (t.parseBookmarkEnd = function (e, t) {
              return { type: a.DomType.BookmarkEnd, id: t.attr(e, "id") };
            });
        },
        191: (e, t, r) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        149: (e, t) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.convertLength = function (e, r = t.LengthUsage.Dxa) {
              return null == e || /.+(p[xt]|[%])$/.test(e)
                ? e
                : `${(parseInt(e) * r.mul).toFixed(2)}${r.unit}`;
            }),
        ...
        120: (e, t) => {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.DomType = void 0),
            ((r = t.DomType || (t.DomType = {})).Document = "document"),
        ...
        931: (e, t) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseLineSpacing = void 0),
            (t.parseLineSpacing = function (e, t) {
              return {
        ...
        109: (e, t, r) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseNumbering =
              t.parseTabs =
              t.parseParagraphProperty =
              t.parseParagraphProperties =
                void 0);
          const a = r(149),
            s = r(59),
            n = r(931),
        ...
        59: (e, t, r) => {
          ...
          var i;
          ((i = t.SectionType || (t.SectionType = {})).Continuous =
            "continuous"),
            (i.NextPage = "nextPage"),
            (i.NextColumn = "nextColumn"),
            (i.EvenPage = "evenPage"),
            (i.OddPage = "oddPage"),
            (t.parseSectionProperties = function (e, t = a.default) {
              var r,
                i,
                c = {};
              for (let a of t.elements(e))
                switch (a.localName) {
                  ...
                  case "headerReference":
                    (null !== (r = c.headerRefs) && void 0 !== r
                      ? r
                      : (c.headerRefs = [])
                    ).push(o(a, t));
                    break;
                  case "footerReference":
                    (null !== (i = c.footerRefs) && void 0 !== i
                      ? i
                      : (c.footerRefs = [])
                    ).push(o(a, t));
                    break;
        ...
        667: (e, t, r) => {
          ...
          (t.defaultOptions = {
            ...
            (t.renderAsync = function (e, r, l = null, o = null) {
              ...
              return a.WordDocument.load(e, new s.DocumentParser(i), i).then(
                (e) => (c.render(e, r, l, i), e)
              );
            });
        },
        380: (e, t, r) => {
        ...
        985: (e, t, r) => {
          ...
          (t.BaseHeaderFooterPart = n),
            (t.HeaderPart = class extends n {
              createRootElement() {
        ...
        932: (e, t, r) => {
          ...
          function d(e, t) {
            t.forEach((t) =>
              e.appendChild((0, s.isString)(t) ? document.createTextNode(t) : t)
            );
          }
          function h(e) {
            return i("style", { innerHTML: e });
          }
          function m(e, t) {
          ...
          t.HtmlRenderer = class {
            ...
            render(e, t, r = null, a) {
              ...
              (this.document = e),
                ...
                p((r = r || t)),
                p(t),
                m(r, "docxjs library predefined styles"),
                r.appendChild(this.renderDefaultStyle()),
                !window.MathMLElement &&
                  a.useMathMLPolyfill &&
                  (m(r, "docxjs mathml polyfill styles"),
                  r.appendChild(h(l.default))),
                e.themePart &&
                  (m(r, "docxjs document theme values"),
                  this.renderTheme(e.themePart, r)),
                null != e.stylesPart &&
                  ((this.styleMap = this.processStyles(e.stylesPart.styles)),
                  m(r, "docxjs document styles"),
                  r.appendChild(this.renderStyles(e.stylesPart.styles))),
                e.numberingPart &&
                  (this.prodessNumberings(e.numberingPart.domNumberings),
                  m(r, "docxjs document numbering styles"),
                  r.appendChild(
                    this.renderNumbering(e.numberingPart.domNumberings, r)
                  )),
                e.footnotesPart &&
                  (this.footnoteMap = (0, s.keyBy)(
                    e.footnotesPart.notes,
                    (e) => e.id
                  )),
                e.endnotesPart &&
                  (this.endnoteMap = (0, s.keyBy)(
                    e.endnotesPart.notes,
                    (e) => e.id
                  )),
                e.settingsPart &&
                  (this.defaultTabSize =
                    null === (n = e.settingsPart.settings) || void 0 === n
                      ? void 0
                      : n.defaultTabStop),
                !a.ignoreFonts &&
                  e.fontTablePart &&
                  this.renderFontTable(e.fontTablePart, r);
              var o = this.renderSections(e.documentPart.body);
              this.options.inWrapper
                ? t.appendChild(this.renderWrapper(o))
                : d(t, o),
            ...
            renderTheme(e, t) {
              ...
              const s = {},
                n =
                  null === (r = e.theme) || void 0 === r
                    ? void 0
                    : r.fontScheme;
              n &&
                (n.majorFont &&
                  (s["--docx-majorHAnsi-font"] = n.majorFont.latinTypeface),
                n.minorFont &&
                  (s["--docx-minorHAnsi-font"] = n.minorFont.latinTypeface));
              const l =
                null === (a = e.theme) || void 0 === a ? void 0 : a.colorScheme;
              if (l)
                for (let [e, t] of Object.entries(l.colors))
                  s[`--docx-${e}-color`] = `#${t}`;
              ...
              for (let r of e.fonts)
                for (let e of r.embedFontRefs)
                  this.document.loadFont(e.id, e.key).then((a) => {
                    ...
                    ("bold" != e.type && "boldItalic" != e.type) ||
                      (s["font-weight"] = "bold"),
                      ("italic" != e.type && "boldItalic" != e.type) ||
                        (s["font-style"] = "italic"),
                      m(t, `docxjs ${r.name} font`);
            ...
            processStyleName(e) {
              return e
                ? `${this.className}_${(0, s.escapeClassName)(e)}`
                : this.className;
            }
            processStyles(e) {
              const t = (0, s.keyBy)(
              ...
              for (const a of e.filter((e) => e.basedOn)) {
                var r = t[a.basedOn];
                if (r) {
                  (a.paragraphProps = (0, s.mergeDeep)(
                    a.paragraphProps,
                    r.paragraphProps
                  )),
                    (a.runProps = (0, s.mergeDeep)(a.runProps, r.runProps));
                  ...
                  this.options.debug &&
                    console.warn(`Can't find base style ${a.basedOn}`);
              }
            ...
            prodessNumberings(e) {
              ...
              for (let r of e.filter((e) => e.pStyleName)) {
                ...
                (null === (t = null == e ? void 0 : e.paragraphProps) ||
                void 0 === t
                  ? void 0
                  : t.numbering) &&
                  (e.paragraphProps.numbering.level = r.level);
              }
            }
            processElement(e) {
              if (e.children)
            ...
            processTable(e) {
              for (var t of e.children)
                for (var r of t.children)
                  (r.cssStyle = this.copyStyleProperties(
                    e.cellStyle,
                    r.cssStyle,
                    [
                      "border-left",
            ...
            copyStyleProperties(e, t, r = null) {
              if (!e) return t;
              for (var a of (null == t && (t = {}),
              null == r && (r = Object.getOwnPropertyNames(e)),
              r))
            ...
            createSection(e, t) {
              ...
              return (
                t &&
                  (t.pageMargins &&
                    ((r.style.paddingLeft = t.pageMargins.left),
                    (r.style.paddingRight = t.pageMargins.right),
                    (r.style.paddingTop = t.pageMargins.top),
                    (r.style.paddingBottom = t.pageMargins.bottom)),
                  t.pageSize &&
                    (this.options.ignoreWidth ||
                      (r.style.width = t.pageSize.width),
                    this.options.ignoreHeight ||
                      (r.style.minHeight = t.pageSize.height)),
                  t.columns &&
                    t.columns.numberOfColumns &&
                    ((r.style.columnCount = `${t.columns.numberOfColumns}`),
                    (r.style.columnGap = t.columns.space),
                    t.columns.separator &&
                      (r.style.columnRule = "1px solid black"))),
                r
              );
            }
            renderSections(e) {
              ...
              for (let n = 0, l = r.length; n < l; n++) {
                ...
                this.renderElements(o.elements, s),
                  c.appendChild(s),
            ...
            renderHeaderFooter(e, t, r, a, s) {
              ...
              if (e) {
                    ...
                    null !==
                      (l =
                        null !==
                          (n =
                            t.titlePage && a
                              ? e.find((e) => "first" == e.type)
                              : null) && void 0 !== n
                          ? n
                          : r % 2 == 1
                          ? e.find((e) => "even" == e.type)
                          : null) && void 0 !== l
                      ? l
                      : e.find((e) => "default" == e.type),
                  i =
                    o &&
                ...
                i &&
                  ((this.currentPart = i),
                  this.usedHederFooterParts.includes(i.path) ||
                    (this.processElement(i.rootElement),
                    this.usedHederFooterParts.push(i.path)),
                  this.renderElements([i.rootElement], s),
                  (this.currentPart = null));
              }
            }
            isPageBreakElement(e) {
              return (
                e.type == a.DomType.Break &&
                ("lastRenderedPageBreak" == e.break
                ...
                if ((r.elements.push(u), u.type == a.DomType.Paragraph)) {
                  ...
                  if (
                    ...
                    if (l < e.children.length - 1 || a) {
                      ...
                      if (
                        ((u.children = i.slice(0, l)), r.elements.push(c), a)
                      ) {
                        let e = t.children,
            ...
            renderNumbering(e, t) {
                ...
                if (s.bullet) {
                  ...
                  (r += this.styleToString(
                    ...
                    this.document.loadNumberingImage(s.bullet.src).then((r) => {
                      var a = `.${this.className}-wrapper { ${e}: url(${r}) }`;
                      t.appendChild(h(a));
                    });
                } else if (s.levelText) {
                  ...
                  s.level > 0
                    ? (r += this.styleToString(
                        `p.${this.numberingClass(s.id, s.level - 1)}`,
                        { "counter-reset": e }
                      ))
                    : a.push(e),
                    (r += this.styleToString(
                      ...
                      Object.assign(
                        {
                          content: this.levelTextToContent(
                            ...
                            s.suff,
                            s.id,
                            this.numFormatToCssValue(s.format)
                          ),
                          "counter-increment": e,
                        },
                        s.rStyle
              ...
              return (
                a.length > 0 &&
                  (r += this.styleToString(`.${this.className}-wrapper`, {
            ...
            renderStyles(e) {
              ...
              for (const s of e) {
                ...
                for (const e of l) {
                  var i = `${
                    null !== (t = s.target) && void 0 !== t ? t : ""
                  }.${s.cssName}`;
                  s.target != e.target && (i += ` ${e.target}`),
                    n[s.target] == s &&
                      (i = `.${this.className} ${s.target}, ` + i),
                    (r += this.styleToString(i, e.values));
                }
              }
              return h(r);
            }
            ...
            renderElement(e) {
              switch (e.type) {
                ...
                case a.DomType.MmlMath:
                  return this.renderContainerNS(e, o, "math", { xmlns: o });
            ...
            renderParagraph(e) {
              ...
              (null !== (t = e.tabs) && void 0 !== t) ||
                (e.tabs =
                  null === (r = null == l ? void 0 : l.paragraphProps) ||
                  void 0 === r
                    ? void 0
                    : r.tabs),
                ...
                this.renderCommonProperties(n.style, e);
              const o =
                null !== (a = e.numbering) && void 0 !== a
                  ? a
                  : null === (s = null == l ? void 0 : l.paragraphProps) ||
                    void 0 === s
                  ? void 0
                  : s.numbering;
              return (
                o && n.classList.add(this.numberingClass(o.id, o.level)), n
              );
            }
            ...
            renderHyperlink(e) {
              ...
              if (
                ...
                const r = this.document.documentPart.rels.find(
                  (t) => t.id == e.id && "External" === t.targetMode
                );
            ...
            renderTab(e) {
              ...
              if (((r.innerHTML = "&emsp;"), this.options.experimental)) {
                ...
                var s =
                  null ===
                    (t = (function (e, t) {
                      for (var r = e.parent; null != r && r.type != t; )
                        r = r.parent;
                      return r;
                    })(e, a.DomType.Paragraph)) || void 0 === t
                    ? void 0
                    : t.tabs;
                this.currentTabs.push({ stops: s, span: r });
              }
              return r;
            }
            ...
            renderTableCell(e) {
              ...
              if (e.verticalMerge) {
                ...
                "restart" == e.verticalMerge
                  ? ((this.currentVerticalMerge[r] = t), (t.rowSpan = 1))
                  : this.currentVerticalMerge[r] &&
                    ((this.currentVerticalMerge[r].rowSpan += 1),
            ...
            renderVmlElement(e) {
              ...
              return (
                ...
                (null === (t = e.imageHref) || void 0 === t ? void 0 : t.id) &&
                  (null === (r = this.document) ||
                    void 0 === r ||
                    r
                      .loadDocumentImage(e.imageHref.id, this.currentPart)
                      .then((e) => s.setAttribute("href", e))),
                a.appendChild(s),
                setTimeout(() => {
                  const e = a.firstElementChild.getBBox();
                  a.setAttribute("width", `${Math.ceil(e.x + e.width)}`),
                    a.setAttribute("height", `${Math.ceil(e.y + e.height)}`);
                }, 0),
                a
              );
            }
            renderMmlRadical(e) {
              ...
              if (
                null === (t = e.props) || void 0 === t ? void 0 : t.hideDegree
              )
                return u(o, "msqrt", null, this.renderElements([r]));
            ...
            renderMmlDelimiter(e) {
              ...
              return (
                a.push(
                  u(o, "mo", null, [
                    null !== (t = e.props.beginChar) && void 0 !== t ? t : "(",
                  ])
                ),
                a.push(...this.renderElements(e.children)),
                a.push(
                  u(o, "mo", null, [
                    null !== (r = e.props.endChar) && void 0 !== r ? r : ")",
                  ])
                ),
                u(o, "mrow", null, a)
              );
            ...
            renderMmlNary(e) {
              ...
              const r = [],
                ...
                c = l ? u(o, "mo", null, [this.renderElement(l)]) : null,
                p = i ? u(o, "mo", null, [this.renderElement(i)]) : null;
              if (null === (t = e.props) || void 0 === t ? void 0 : t.char) {
                const t = u(o, "mo", null, [e.props.char]);
                c || p
                  ? r.push(u(o, "munderover", null, [t, p, c]))
                  : c
                  ? r.push(u(o, "mover", null, [t, c]))
                  : p
                  ? r.push(u(o, "munder", null, [t, p]))
                  : r.push(t);
              }
              return (
                r.push(...this.renderElements(n[a.DomType.MmlBase].children)),
                u(o, "mrow", null, r)
              );
            }
            ...
            findStyle(e) {
              ...
              return (
                e &&
                (null === (t = this.styleMap) || void 0 === t ? void 0 : t[e])
              );
            }
            numberingClass(e, t) {
            ...
            levelTextToContent(e, t, r, a) {
              ...
              return `"${e.replace(/%\d*/g, (e) => {
                ...
                null !== (s = { tab: "\\9", space: "\\a0" }[t]) && void 0 !== s
                  ? s
                  : ""
              }"`;
            }
        ...
        630: (e, t) => {
          ...
          (t.computePixelToPoint = function (e = document.body) {
            ...
            (t.updateTabStop = function (e, t, s, n = 0.75) {
              const l = e.closest("p"),
              ...
              if (m < d)
                for (; m < d && u.length < 50; m += h)
                  u.push(Object.assign(Object.assign({}, r), { pos: m }));
              ...
              if ("right" == y.style || "center" == y.style) {
                ...
                a.setStart(e, 1),
                  r < t.length ? a.setEndBefore(t[r]) : a.setEndAfter(l);
                const s = "center" == y.style ? 0.5 : 1,
              ...
              switch (
                ...
                (e.style.wordSpacing = `${v.toFixed(0)}pt`),
                y.leader)
              ) {
                case "dot":
                case "middleDot":
        ...
        735: (e, t, r) => {
          ...
          (t.BaseNotePart = n),
            (t.FootnotesPart = class extends n {
              constructor(e, t, r) {
                super(e, t, r);
              }
              parseXml(e) {
                this.notes = this._documentParser.parseNotes(
                  e,
                  "footnote",
                  s.WmlFootnote
                );
        ...
        527: (e, t, r) => {
          ...
          class n extends a.Part {
            ...
            parseXml(e) {
              Object.assign(
                this,
                (0, s.parseNumberingPart)(e, this._package.xmlParser)
              ),
                (this.domNumberings =
                  this._documentParser.parseNumberingFile(e));
            }
          }
          t.NumberingPart = n;
        },
        682: (e, t, r) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseNumberingBulletPicture =
              t.parseNumberingLevelOverrride =
              t.parseNumberingLevel =
              t.parseAbstractNumbering =
              t.parseNumbering =
              t.parseNumberingPart =
                void 0);
          const a = r(109),
            s = r(488);
          function n(e, t) {
          ...
          (t.parseNumberingPart = function (e, t) {
            ...
            (t.parseNumbering = n),
            (t.parseAbstractNumbering = l),
            (t.parseNumberingLevel = o),
            (t.parseNumberingLevelOverrride = i),
            (t.parseNumberingBulletPicture = c);
        },
        472: (e, t, r) => {
          Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.parseXmlString = function (e, t = !1) {
            ...
            const r = new DOMParser().parseFromString(e, "application/xml"),
              a =
                null === (s = r.getElementsByTagName("parsererror")[0]) ||
                void 0 === s
                  ? void 0
                  : s.textContent;
            var s;
        ...
        846: (e, t) => {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            (t.parseNoteProperties = t.parseSettings = void 0),
            (t.parseSettings = function (e, t) {
              var a = {};
              for (let s of t.elements(e))
                switch (s.localName) {
                  case "defaultTabStop":
        ...
        55: (e, t) => {
          ...
          function a(e, t) {
            ...
            for (let n of t.elements(e)) {
              ...
              a
                ? (r.colors[n.localName] = t.attr(a, "val"))
                : s && (r.colors[n.localName] = t.attr(s, "lastClr"));
            }
            return r;
          }
          function s(e, t) {
          ...
          (t.DmlTheme = r),
            (t.parseTheme = function (e, t) {
              var n = new r(),
                l = t.element(e, "themeElements");
              for (let e of t.elements(l))
                switch (e.localName) {
                  case "clrScheme":
                    n.colorScheme = a(e, t);
                    break;
        ...
        320: (e, t, r) => {
          ...
          class l {
            constructor() {
              (this.type = s.DomType.VmlElement),
                (this.attrs = {}),
                (this.chidren = []);
            }
          }
          function o(e) {
            ...
            return {
              ...
              "stroke-width":
                null !==
                  (t = n.default.lengthAttr(e, "weight", a.LengthUsage.Emu)) &&
                void 0 !== t
                  ? t
                  : "1px",
            };
          ...
          (t.VmlElement = l),
            (t.parseVmlElement = function e(t) {
              var r = new l();
              switch (t.localName) {
                case "rect":
                  (r.tagName = "rect"),
                    Object.assign(r.attrs, { width: "100%", height: "100%" });
                  break;
                case "oval":
                  (r.tagName = "ellipse"),
              ...
              for (const e of n.default.attrs(t))
                switch (e.localName) {
                  case "style":
                  ...
                  case "from":
                    const [t, a] = i(e.value);
                    Object.assign(r.attrs, { x1: t, y1: a });
                    break;
                  case "to":
                    const [s, n] = i(e.value);
                    Object.assign(r.attrs, { x2: s, y2: n });
                }
              for (const a of n.default.elements(t))
                switch (a.localName) {
                  case "stroke":
        ...
        213: (e, t, r) => {
          ...
          class y {
            ...
            static load(e, t, r) {
              ...
              return (
                (a._options = r),
                (a._parser = t),
                n.OpenXmlPackage.load(e, r)
                  .then(
                    (e) => ((a._package = e), a._package.loadRelationships())
                  )
                  .then((e) => {
                    a.rels = e;
                    const t = b.map((t) => {
            ...
            loadRelationshipPart(e, t) {
              ...
              switch (t) {
                case a.RelationshipTypes.OfficeDocument:
                  this.documentPart = r = new l.DocumentPart(
                    this._package,
                    e,
                    this._parser
                  );
                ...
                case a.RelationshipTypes.FontTable:
                  this.fontTablePart = r = new s.FontTablePart(
                    this._package,
                    e
                  );
                  break;
                case a.RelationshipTypes.Numbering:
                  this.numberingPart = r = new i.NumberingPart(
                    this._package,
                    e,
                    this._parser
                  );
                ...
                case a.RelationshipTypes.Styles:
                  this.stylesPart = r = new c.StylesPart(
                    this._package,
                    e,
                    this._parser
                  );
                ...
                case a.RelationshipTypes.Footnotes:
                  this.footnotesPart = r = new m.FootnotesPart(
                    this._package,
                    e,
                    this._parser
                  );
                ...
                case a.RelationshipTypes.Endnotes:
                  this.endnotesPart = r = new m.EndnotesPart(
                    this._package,
                    e,
                    this._parser
                  );
                ...
                case a.RelationshipTypes.CoreProperties:
                  this.corePropsPart = r = new d.CorePropsPart(
                    this._package,
                    e
                  );
                  break;
                case a.RelationshipTypes.ExtendedProperties:
                  this.extendedPropsPart = r = new p.ExtendedPropsPart(
                    this._package,
                    e
                  );
                  break;
            ...
            loadDocumentImage(e, t) {
              return this.loadResource(
                null != t ? t : this.documentPart,
                e,
                "blob"
              ).then((e) => this.blobToURL(e));
            }
            loadNumberingImage(e) {
              return this.loadResource(this.numberingPart, e, "blob").then(
                (e) => this.blobToURL(e)
              );
            }
            loadFont(e, t) {
              return this.loadResource(
                ...
                e,
                "uint8array"
              ).then((e) => (e ? this.blobToURL(new Blob([v(e, t)])) : e));
            }
            blobToURL(e) {
              return e
            ...
            findPartByRelId(e, t = null) {
              var r,
                a = (
                  null !== (r = t.rels) && void 0 !== r ? r : this.rels
                ).find((t) => t.id == e);
          ...
          function v(e, t) {
            const r = t.replace(/{|}|-/g, ""),
              a = new Array(16);
            for (let e = 0; e < 16; e++)
              a[16 - e - 1] = parseInt(r.substr(2 * e, 2), 16);
